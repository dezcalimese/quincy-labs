...
async function getResearchNotesPosts() {
  try {
    const query = `
      *[_type == "blogPost" && category == "research-notes"] | order(publishedAt desc) {
        _id,
        title,
        slug,
        publishedAt,
...
export default async function ResearchNotesPage() {
  const posts = await getResearchNotesPosts()
      ...
      <div className="space-y-8">
        ...
        {posts.length > 0 ? (
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 text-center">
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              No research notes available yet. Our research notes will be published here and on our external platforms.
            </p>
